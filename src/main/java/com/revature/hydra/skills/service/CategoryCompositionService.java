...
public class CategoryCompositionService {
	...
	// @Autowired
	// private CategoryCompositionMessagingService
	// categoryCompositionMessagingService;
	...
	/**
	 * . Given a Category create a simple version and saves it
	 *
	 * @param A
	...
	/**
	 * . Given a Category create a simple version and use it to update
	 *
	 * @param A
